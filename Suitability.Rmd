...
Overlay of non-fixed layers
```{r}
# Note: all layers need to have the same extent and resolution
suitable <- overlay(sst_binary_min,
                    sst_binary_max,
                    depth_binary,
                    current_binary,
                    dist_shore_binary,
...
Overlay of Env. constrains
```{r}
# Following presentation slides
env_constrains <-  overlay(sst_binary_min,
                           sst_binary_max,
                           current_binary,
...
Overlay of Fixed Barrier Layers
```{r}
# Following presentation slides
cropped_layers <-  overlay(mpas_binary,
                           reefs_binary,
