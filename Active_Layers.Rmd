...
mpas_BRA_res <- resample(mpas_BR, min_sst_BRA, method='ngb',progress='text')
...
dist_to_shore <- raster(paste0(path,"/distance_to_shore.tif"))
...
shore_distance_mask <- dist_to_shore < max_shore_distance
