...
# Distance from Shore Mask
```{r}

# Set Max Distance
max_shore_distance <- 25

# Create a Raster
shore_raster <- ne_countries(scale = "110", country = "Brazil", returnclass = "sf") %>% 
  sf::st_crop(eez_BRA)

shore_distance

shore_distance_mask <- shore_distance > max_shore_distance
