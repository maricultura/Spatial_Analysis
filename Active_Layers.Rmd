...
# Reproject CRS
# Have to turn into a sf to use st_transform
#min_sst_rpj <- sp_transform(min_sst, CRS("+init=epsg:5880"))
#max_sst_rpj <- st_transform(max_sst, CRS("+init=epsg:5880"))
...
# Reproject CRS
# Have to turn into a sf to use st_transform
depth_rpj <- projectRaster(from = depth, crs = "+proj=poly +lat_0=0 +lon_0=-54 +x_0=5000000 +y_0=10000000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", method = "bilinear")
...
# Reproject CRS
# Have to turn into a sf to use st_transform
#max_cv_rpj <- spTransform(max_cv, CRS("+init=epsg:5880"))
